        ...
        <div className="space-y-4">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-white text-gray-500">More providers coming soon</span>
            </div>
          </div>
          ...
          <div className="space-y-3 opacity-50 pointer-events-none">
            <Button
              disabled
              className="w-full h-12 text-base font-medium bg-white text-gray-700 border border-gray-300"
            >
